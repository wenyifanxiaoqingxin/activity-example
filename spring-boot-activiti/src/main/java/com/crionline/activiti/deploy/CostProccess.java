 ...
 */
public class CostProccess {
    ProcessEngine engine = ProcessEngines.getDefaultProcessEngine();

    private String processInstanceId="135001";
    //部署
    @Test
    public void deploy() throws FileNotFoundException {

        InputStream inputStream = this.getClass().getResourceAsStream("/processes/exclusiveGateWay.bpmn");
        InputStream inputStreamPng = this.getClass().getResourceAsStream("/processes/exclusiveGateWay.png");

        Deployment deployment = engine.getRepositoryService()
                .createDeployment()
                .addInputStream("exclusiveGateWay.bpmn",inputStream)
